...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        metainfo=metainfo,
        ann_file=f'fp_annotations/test_clipart1k_new_merged.json',
...
val_dataloader = dict(
    ...
    dataset=dict(
        _delete_=True,
        type='CocoDataset',
        data_root=fp_data_root,
        metainfo=metainfo,
        ann_file=f'fp_annotations/test_dior_new_merged.json',
        data_prefix=dict(img='test/'),
...
val_evaluator = dict(
    ann_file=f'{fp_data_root}/fp_annotations/test_clipart1k_new_merged.json')
